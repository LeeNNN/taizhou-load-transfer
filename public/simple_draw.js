draw1 = {
    ...
    init: function (dom, data, opition) {
        ...
        this.CURRENT_FEEDER_ID = data.topology.children[0].id;
    ...
    renderCombine: function (node, nodeX, nodeY, chidlNode) {
        ...
        if (node.combinedId != undefined && node.combinedId != null && node.combinedId != 0 && node.combinedName.indexOf("分支箱") < 0 && (node.feederId == this.CURRENT_FEEDER_ID || (node.feederId == undefined && node.feederId == null))) {
            var o = [];
            var combineInfo = {};
